...
export default function ContactPage() {
  ...
  <section className="w-full bg-cream h-[45vh]">
      
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="var(--color-seagreen)" fill-opacity="1" d="M0,288L26.7,261.3C53.3,235,107,181,160,176C213.3,171,267,213,320,240C373.3,267,427,277,480,256C533.3,235,587,181,640,149.3C693.3,117,747,107,800,128C853.3,149,907,203,960,197.3C1013.3,192,1067,128,1120,133.3C1173.3,139,1227,213,1280,234.7C1333.3,256,1387,224,1413,208L1440,192L1440,320L1413.3,320C1386.7,320,1333,320,1280,320C1226.7,320,1173,320,1120,320C1066.7,320,1013,320,960,320C906.7,320,853,320,800,320C746.7,320,693,320,640,320C586.7,320,533,320,480,320C426.7,320,373,320,320,320C266.7,320,213,320,160,320C106.7,320,53,320,27,320L0,320Z"></path>
      </svg>
        <div className="relative w-full h-full mt-[-3px]">
