        ...
        <div className="relative min-h-screen pt-14">
            <div className='flex flex-col justify-center items-center'>
                ...
                <div className="h-full">
                    ...
                    {/* TODO: uncomment when we have content */}
                    ...
                    <div className="min-h-[75vh] flex flex-col items-center justify-center py-20">
                        <h2 className="text-3xl font-bold text-gray-800 mb-4">Stay tuned for bioinformatics content!</h2>
                        <p className="text-lg text-gray-600">Our members are working on insightful blog posts. Check back soon.</p>
                    </div>
                </div>
            </div>
        </div>
